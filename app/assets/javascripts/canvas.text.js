...
(function(){
  ...
  ctxt.options = {
    ...
    dontUseMoz: true, // Don't use the builtin Firefox 3.0 functions (mozDrawText, mozPathText and mozMeasureText)
    reimplement: true, // Don't use the builtin official functions present in Chrome 2, Safari 4, and Firefox 3.1+
