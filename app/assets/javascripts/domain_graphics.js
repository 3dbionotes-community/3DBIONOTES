...
var PfamGraphic = Class.create( {
  ...
  _addListeners: function() {
    ...
    this._canvas.observe( "mousemove", function( e ) {
      ...
      areasList.each( function( area ) {
        if ( x >= (area.coords[0]-10) && x <= (area.coords[2]+10) &&
             y >= (area.coords[1]-10) && y <= (area.coords[3]+10) ) {
          activeArea = area;
  ...
  _handleClick: function( e ) {
    ...
    areasList.reverse().each( function( area ) {
      if ( x > (area.coords[0]-4) && x < (area.coords[2]+4) &&
           y > (area.coords[1]-4) && y < (area.coords[3]+4) ) {
        activeArea = area;
        //throw $break;
      }  
    } );
