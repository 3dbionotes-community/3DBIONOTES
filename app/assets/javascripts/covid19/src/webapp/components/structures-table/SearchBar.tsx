...
export const SearchBar: React.FC<SearchBarProps> = React.memo(props => {
    ...
    const [autoSuggestionOptions, setAutoSuggestionOptions] = React.useState<Array<string>>(["6YOR", "Homo sapiens", "SARS-CoV-2"]);
...
const styles = {
    ...
    chip: { margin: 2 },
    chips: { display: "flex" as const, justifyContent: "center", flexWrap: "wrap" as const, listStyle: "none", margin: 0 }
};
