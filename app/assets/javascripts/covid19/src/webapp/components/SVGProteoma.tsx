...
export const SVGProteoma: React.FC<SVGProteomaProps> = React.memo(props => {
    const { search, setSearch, visible, setVisible, title, setTitle, setProteomaSelected } = props;
    const [loading, setLoading] = React.useState(false);
    const stateSetters = { setSearch, setTitle, setProteomaSelected, setLoading };
...
const ProteomaPath: React.FC<ProteomaPathProps> = React.memo(props => {
    const {
        name,
        classStyle,
        def,
        stateSetters: { setTitle, setSearch, setProteomaSelected, setLoading },
    } = props;
