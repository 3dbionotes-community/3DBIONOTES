...
export const SVGProteoma: React.FC<SVGProteomaProps> = React.memo(props => {
    const { setSearch, visible, setVisible, title, setTitle, setProteomaSelected } = props;
    const stateSetters = { setSearch, setVisible, setProteomaSelected };
    return (
        <Container>
...
const Path: React.FC<PathProps> = React.memo(props => {
    const {
        ...
        classStyle,
        def,
        stateSetters: { setTitle, setSearch, setProteomaSelected },
    } = props;
    return (
        <path
            ...
            onClick={() => {
                ...
                setProteomaSelected && setProteomaSelected(true);
                sendAnalytics({
                    type: "event",
                    category: "proteoma",
                    action: "select",
