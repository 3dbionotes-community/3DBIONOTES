...
function useGrid() {
    ...
    React.useEffect(() => {
            ...
            for (let row = 0; row < numRows; row++) {
                ...
                for (let column = 0; column < numCols; column++) {
                    ...
                    data[row].push({
                        ...
                        color: (cellXValue === "1" || cellXValue === "3")  && (cellYValue === "1" || cellYValue === "2") ? 'red' : (cellXValue === "1" || cellXValue === "3") && (cellYValue === "3") ? "orange" : (cellXValue === "2" && cellYValue === "4") ? "lime" : (cellXValue === "2" && cellYValue === "3") ? "greenyellow" : 'yellow',
                    });
                    xPos += width;
                    i++;
                }
        ...
        grid.append("text")             
            .attr("transform", "translate(" + (dimensions.width) + " ," + (dimensions.height + margin.top) + ")")
            .style("text-anchor", "middle")
            .attr("font-size", "0.75em")
            .text(axisX);
