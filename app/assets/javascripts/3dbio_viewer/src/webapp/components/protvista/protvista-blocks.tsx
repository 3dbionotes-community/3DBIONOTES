...
import { BlockComponentProps, BlockDef } from "./Protvista.types";
...
export const getBlockDefs: (protein: Maybe<Protein>) => BlockDef[] = protein =>
    _.compact([
        {
            id: "basicInfo",
        ...
        protein && {
            ...
            component: React.memo((props: BlockComponentProps) => {
                return <ChainInfoViewer selection={props.selection} protein={protein} />;
            }),
            tracks: [],
            profiles: [
                profiles.structural,
