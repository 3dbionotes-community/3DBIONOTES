...
function __init_local(i,v_c,v_t,local_flag){
	...
	self.Structures[ __name ]['representations']['selection']['ball+stick'] = i.addRepresentation("ball+stick",{visible:false,sele:"/0 and protein",color:"#FFE999"});
        self.Structures[ __name ]['representations']['multiple_selection'] = [];
        self.Structures[ __name ]['representations']['multiple_cartoon'] = [];
	...
	self.start = function(){
			...
			if( self.args.emdb ){
				var __emdb = self.args.emdb.replace("EMD-", "emd_");
                                ...
                                var __map = "https://3dbionotes.cnb.csic.es/ws/pond/maps/"+self.args.emdb+"/file/"+__emdb+".map.gz"
