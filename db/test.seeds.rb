...
BiomutaUrl = "https://hive.biochemistry.gwu.edu/tools/biomuta/download2.php?f=BioMuta3.csv"
...
def processBiomuta
	...
	data = `sort -k2 /home/joan/apps/bionotes/data/download/BioMuta.csv | awk '{if($10!=$11)print $0}'`
	data = data.split(/\n/)
